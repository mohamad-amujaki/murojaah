...
export const Goal = memo(function Goal({ icon:Icon, color, title, subtitle, value, max }: { icon:typeof Home; color:string; title:string; subtitle:string; value:number; max:number }) {
